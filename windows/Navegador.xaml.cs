...
namespace UD2_2_Bouzas_Prado_Bran.windows
{
    public partial class Navegador : Window
    {
        ...
        private Opciones<NavegadorEnums> _opciones;
        ...
        public Navegador(MainWindow mainWindow, VoiceRecognizer voz)
        {
            ...
            _opciones = new Opciones<NavegadorEnums>();
            _opciones.Show();
        ...
        private void BtnBuscar_Click(object sender, RoutedEventArgs e)
        {
            ...
            string url = texto.StartsWith("http", StringComparison.OrdinalIgnoreCase) ? texto : $"https://www.google.com/search?q={Uri.EscapeDataString(texto)}";
        ...
        private async void BtnVoz_Click(object sender, RoutedEventArgs e)
        {
            ...
            var acciones = new Dictionary<NavegadorEnums, Action>
            {
                ...
                { NavegadorEnums.Volver, () => this.Close() }
            };
